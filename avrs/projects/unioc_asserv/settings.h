...
#define SETTING_PID_A_GAIN_I (50)
...
#define SETTING_TRAJECTORY_A_SPEED (150.0)
#define SETTING_TRAJECTORY_A_ACC   (1.0)
...
#define SETTING_AUTOSET_SPEED (5000000.0)
#define SETTING_AUTOSET_ZEROSPEED (30)
#define SETTING_AUTOSET_ZEROCOUNT (20)
...
// -- color detection --
#define SETTING_COLOR_DETECTOR_0 (0x1900)
#define SETTING_COLOR_DETECTOR_120 (0x1A00)
#define SETTING_COLOR_DETECTOR_240 (0x1B00)

#define SETTING_COLOR_DETECTOR_0_RED_THRESHOLD (15)
#define SETTING_COLOR_DETECTOR_0_BLUE_THRESHOLD (100)
#define SETTING_COLOR_DETECTOR_120_RED_THRESHOLD (15)
#define SETTING_COLOR_DETECTOR_120_BLUE_THRESHOLD (100)
#define SETTING_COLOR_DETECTOR_240_RED_THRESHOLD (15)
#define SETTING_COLOR_DETECTOR_240_BLUE_THRESHOLD (100)

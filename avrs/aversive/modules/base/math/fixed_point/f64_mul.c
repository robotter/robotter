 ...
 *
 *  Revision : $Id: f64_mul.c,v 1.6 2008-05-14 13:27:12 zer0 Exp $
 *
 */
...
{
	return s64_to_f64( ( ((int64_t)(a.f64_integer) * (int64_t)(b.f64_integer)) << 32 ) +
			   (int64_t)(a.f64_integer) * (int64_t)(b.f64_decimal)             +
			   (int64_t)(a.f64_decimal) * (int64_t)(b.f64_integer)             +
			   ( ((int64_t)(a.f64_decimal) * (int64_t)(b.f64_decimal)) >> 32 ) );
}

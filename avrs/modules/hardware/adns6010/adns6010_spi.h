...
#ifndef _ADNS6010_SPI_H_
#define _ADNS6010_SPI_H_

#define ADNS6010_SPI_WRITE 0x80

/** @brief Initialize FPGA/SPI interface
  */
void adns6010_spi_init(void);
...
/** @brief Receive a byte from an ADNS by SPI
  ...
  */
uint8_t adns6010_spi_recv(void);

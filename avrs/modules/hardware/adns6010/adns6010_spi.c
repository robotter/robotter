...
void adns6010_spi_cs(uint8_t cs)
{
  ...
  byte = ADNS6010_SPI_CTRL;

	switch(cs)
	{
		case 0:
      // No ADNS selected
			cbi(byte,ADNS6010_SPICTRL_BIT_CS0);
			cbi(byte,ADNS6010_SPICTRL_BIT_CS1);
			break;

		case 1:
      // ADNS#1
			sbi(byte,ADNS6010_SPICTRL_BIT_CS0);
			cbi(byte,ADNS6010_SPICTRL_BIT_CS1);
			break;
      ...
      // ADNS#2
			cbi(byte,ADNS6010_SPICTRL_BIT_CS0);
			sbi(byte,ADNS6010_SPICTRL_BIT_CS1);
			break;

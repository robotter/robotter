...
entity top_uniocng_propmmx is
  ...
  generic (
    ...
    pwm_id_c                      : natural                       := 5;
    color_sensor_0_id_c           : natural                       := 7;
    color_sensor_1_id_c           : natural                       := 8;
    color_sensor_2_id_c           : natural                       := 9;
  ...
  port
    (
      ...
      -- color_sensor_0
      color_sensor_0_red_apds_9700_enable_no : out std_logic;
      color_sensor_0_red_apds_9700_pwm_o     : out std_logic;
      color_sensor_0_red_apds_9700_dout_i    : in  std_logic;

      color_sensor_0_blue_apds_9700_enable_no : out std_logic;
      color_sensor_0_blue_apds_9700_pwm_o     : out std_logic;
      color_sensor_0_blue_apds_9700_dout_i    : in  std_logic;

      -- color_sensor_1
      color_sensor_1_red_apds_9700_enable_no : out std_logic;
      color_sensor_1_red_apds_9700_pwm_o     : out std_logic;
      color_sensor_1_red_apds_9700_dout_i    : in  std_logic;

      color_sensor_1_blue_apds_9700_enable_no : out std_logic;
      color_sensor_1_blue_apds_9700_pwm_o     : out std_logic;
      color_sensor_1_blue_apds_9700_dout_i    : in  std_logic;

      -- color_sensor_2
      color_sensor_2_red_apds_9700_enable_no : out std_logic;
      color_sensor_2_red_apds_9700_pwm_o     : out std_logic;
      color_sensor_2_red_apds_9700_dout_i    : in  std_logic;

      color_sensor_2_blue_apds_9700_enable_no : out std_logic;
      color_sensor_2_blue_apds_9700_pwm_o     : out std_logic;
      color_sensor_2_blue_apds_9700_dout_i    : in  std_logic
      );
...
architecture top_uniocng_propmmx_1 of top_uniocng_propmmx is
  ...
  -- color_sensor_0
  -- clock
  signal color_sensor_0_wbs_clk_i : std_logic;
  signal color_sensor_0_wbs_rst_i : std_logic;
  -- swb8
  signal color_sensor_0_wbs_adr_i : std_logic_vector(5 downto 0);
  signal color_sensor_0_wbs_dat_i : std_logic_vector(7 downto 0);
  signal color_sensor_0_wbs_dat_o : std_logic_vector(7 downto 0);
  signal color_sensor_0_wbs_we_i  : std_logic;
  signal color_sensor_0_wbs_stb_i : std_logic;
  signal color_sensor_0_wbs_cyc_i : std_logic;
  signal color_sensor_0_wbs_ack_o : std_logic;

  -- color_sensor_1
  -- clock
  signal color_sensor_1_wbs_clk_i : std_logic;
  signal color_sensor_1_wbs_rst_i : std_logic;
  -- swb8
  signal color_sensor_1_wbs_adr_i : std_logic_vector(5 downto 0);
  signal color_sensor_1_wbs_dat_i : std_logic_vector(7 downto 0);
  signal color_sensor_1_wbs_dat_o : std_logic_vector(7 downto 0);
  signal color_sensor_1_wbs_we_i  : std_logic;
  signal color_sensor_1_wbs_stb_i : std_logic;
  signal color_sensor_1_wbs_cyc_i : std_logic;
  signal color_sensor_1_wbs_ack_o : std_logic;

  -- color_sensor_2
  -- clock
  signal color_sensor_2_wbs_clk_i : std_logic;
  signal color_sensor_2_wbs_rst_i : std_logic;
  -- swb8
  signal color_sensor_2_wbs_adr_i : std_logic_vector(5 downto 0);
  signal color_sensor_2_wbs_dat_i : std_logic_vector(7 downto 0);
  signal color_sensor_2_wbs_dat_o : std_logic_vector(7 downto 0);
  signal color_sensor_2_wbs_we_i  : std_logic;
  signal color_sensor_2_wbs_stb_i : std_logic;
  signal color_sensor_2_wbs_cyc_i : std_logic;
  signal color_sensor_2_wbs_ack_o : std_logic;
...
begin
  ...
  atmega_nodir_wb8_wrapper00_mwb8_intercon : atmega_nodir_wb8_wrapper00_mwb8
    generic map(
      ...
      color_sensor_0_base_address_c => color_sensor_0_base_address_c,
      color_sensor_1_base_address_c => color_sensor_1_base_address_c,
      color_sensor_2_base_address_c => color_sensor_2_base_address_c
      )
    port map (
      -- pwm_swb8
      ...
      -- color_sensor_0_swb8
      color_sensor_0_wbs_adr_i => color_sensor_0_wbs_adr_i,
      color_sensor_0_wbs_dat_i => color_sensor_0_wbs_dat_i,
      color_sensor_0_wbs_dat_o => color_sensor_0_wbs_dat_o,
      color_sensor_0_wbs_we_i  => color_sensor_0_wbs_we_i,
      color_sensor_0_wbs_stb_i => color_sensor_0_wbs_stb_i,
      color_sensor_0_wbs_cyc_i => color_sensor_0_wbs_cyc_i,
      color_sensor_0_wbs_ack_o => color_sensor_0_wbs_ack_o,

      -- color_sensor_0_clock connection
      color_sensor_0_wbs_clk_i => color_sensor_0_wbs_clk_i,
      color_sensor_0_wbs_rst_i => color_sensor_0_wbs_rst_i,

       -- color_sensor_1_swb8
      color_sensor_1_wbs_adr_i => color_sensor_1_wbs_adr_i,
      color_sensor_1_wbs_dat_i => color_sensor_1_wbs_dat_i,
      color_sensor_1_wbs_dat_o => color_sensor_1_wbs_dat_o,
      color_sensor_1_wbs_we_i  => color_sensor_1_wbs_we_i,
      color_sensor_1_wbs_stb_i => color_sensor_1_wbs_stb_i,
      color_sensor_1_wbs_cyc_i => color_sensor_1_wbs_cyc_i,
      color_sensor_1_wbs_ack_o => color_sensor_1_wbs_ack_o,

      -- color_sensor_1_clock connection
      color_sensor_1_wbs_clk_i => color_sensor_1_wbs_clk_i,
      color_sensor_1_wbs_rst_i => color_sensor_1_wbs_rst_i,

      -- color_sensor_2_swb8
      color_sensor_2_wbs_adr_i => color_sensor_2_wbs_adr_i,
      color_sensor_2_wbs_dat_i => color_sensor_2_wbs_dat_i,
      color_sensor_2_wbs_dat_o => color_sensor_2_wbs_dat_o,
      color_sensor_2_wbs_we_i  => color_sensor_2_wbs_we_i,
      color_sensor_2_wbs_stb_i => color_sensor_2_wbs_stb_i,
      color_sensor_2_wbs_cyc_i => color_sensor_2_wbs_cyc_i,
      color_sensor_2_wbs_ack_o => color_sensor_2_wbs_ack_o,

      -- color_sensor_2_clock connection
      color_sensor_2_wbs_clk_i => color_sensor_2_wbs_clk_i,
      color_sensor_2_wbs_rst_i => color_sensor_2_wbs_rst_i,
  ...
  color_sensor_00 : color_sensor_top
    generic map (
      c_id                             => color_sensor_0_id_c,
      c_fpga_frequency_khz             => freq_fpga_c,
    ...
    port map(
      -- wishbone interface
      wbs_adr_i => color_sensor_0_wbs_adr_i,
      wbs_dat_i => color_sensor_0_wbs_dat_i,
      wbs_dat_o => color_sensor_0_wbs_dat_o,
      wbs_we_i  => color_sensor_0_wbs_we_i,
      wbs_stb_i => color_sensor_0_wbs_stb_i,
      wbs_cyc_i => color_sensor_0_wbs_cyc_i,
      wbs_ack_o => color_sensor_0_wbs_ack_o,

      wbs_clk_i => color_sensor_0_wbs_clk_i,
      wbs_rst_i => color_sensor_0_wbs_rst_i,

      red_apds9700_enable_no => color_sensor_0_red_apds_9700_enable_no,
      red_apds9700_pwm_o     => color_sensor_0_red_apds_9700_pwm_o,
      red_apds9700_dout_i    => color_sensor_0_red_apds_9700_dout_i,

      blue_apds9700_enable_no => color_sensor_0_blue_apds_9700_enable_no,
      blue_apds9700_pwm_o     => color_sensor_0_blue_apds_9700_pwm_o,
      blue_apds9700_dout_i    => color_sensor_0_blue_apds_9700_dout_i
      );


  color_sensor_01 : color_sensor_top
    generic map (
      c_id                             => color_sensor_1_id_c,
      c_fpga_frequency_khz             => freq_fpga_c,
      c_color_measure_interval_us      => c_color_measure_interval_us,
      c_apds_enable_to_ledPwm_delay_us => c_apds_enable_to_ledPwm_delay_us,
      c_led_pwm_frequency_khz          => c_led_pwm_frequency_khz,
    ...
    port map(
      -- wishbone interface
      wbs_adr_i => color_sensor_1_wbs_adr_i,
      wbs_dat_i => color_sensor_1_wbs_dat_i,
      wbs_dat_o => color_sensor_1_wbs_dat_o,
      wbs_we_i  => color_sensor_1_wbs_we_i,
      wbs_stb_i => color_sensor_1_wbs_stb_i,
      wbs_cyc_i => color_sensor_1_wbs_cyc_i,
      wbs_ack_o => color_sensor_1_wbs_ack_o,

      wbs_clk_i => color_sensor_1_wbs_clk_i,
      wbs_rst_i => color_sensor_1_wbs_rst_i,

      red_apds9700_enable_no => color_sensor_1_red_apds_9700_enable_no,
      red_apds9700_pwm_o     => color_sensor_1_red_apds_9700_pwm_o,
      red_apds9700_dout_i    => color_sensor_1_red_apds_9700_dout_i,

      blue_apds9700_enable_no => color_sensor_1_blue_apds_9700_enable_no,
      blue_apds9700_pwm_o     => color_sensor_1_blue_apds_9700_pwm_o,
      blue_apds9700_dout_i    => color_sensor_1_blue_apds_9700_dout_i
      );

  color_sensor_02 : color_sensor_top
    generic map (
      c_id                             => color_sensor_2_id_c,
      c_fpga_frequency_khz             => freq_fpga_c,
      c_color_measure_interval_us      => c_color_measure_interval_us,
      c_apds_enable_to_ledPwm_delay_us => c_apds_enable_to_ledPwm_delay_us,
      c_led_pwm_frequency_khz          => c_led_pwm_frequency_khz,
    ...
    port map(
      -- wishbone interface
      wbs_adr_i => color_sensor_2_wbs_adr_i,
      wbs_dat_i => color_sensor_2_wbs_dat_i,
      wbs_dat_o => color_sensor_2_wbs_dat_o,
      wbs_we_i  => color_sensor_2_wbs_we_i,
      wbs_stb_i => color_sensor_2_wbs_stb_i,
      wbs_cyc_i => color_sensor_2_wbs_cyc_i,
      wbs_ack_o => color_sensor_2_wbs_ack_o,

      wbs_clk_i => color_sensor_2_wbs_clk_i,
      wbs_rst_i => color_sensor_2_wbs_rst_i,

      red_apds9700_enable_no => color_sensor_2_red_apds_9700_enable_no,
      red_apds9700_pwm_o     => color_sensor_2_red_apds_9700_pwm_o,
      red_apds9700_dout_i    => color_sensor_2_red_apds_9700_dout_i,

      blue_apds9700_enable_no => color_sensor_2_blue_apds_9700_enable_no,
      blue_apds9700_pwm_o     => color_sensor_2_blue_apds_9700_pwm_o,
      blue_apds9700_dout_i    => color_sensor_2_blue_apds_9700_dout_i
      );

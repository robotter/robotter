...
begin
    ...
    begin
        if rstext_syscon00_gls_reset='1' then
            ...
            if atmega_nodir_wb8_wrapper00_wbm_address(14 downto 6)="000000000" and atmega_nodir_wb8_wrapper00_wbm_strobe='1' then
                adns601000_swb8_cs <= '1';
            else
                adns601000_swb8_cs <= '0';
            end if;

            if atmega_nodir_wb8_wrapper00_wbm_address(14 downto 3)="000000001000" and atmega_nodir_wb8_wrapper00_wbm_strobe='1' then
                encoder_inc00_swb8_cs <= '1';
            else
                encoder_inc00_swb8_cs <= '0';
            end if;

            if atmega_nodir_wb8_wrapper00_wbm_address(14 downto 3)="000000001001" and atmega_nodir_wb8_wrapper00_wbm_strobe='1' then
                encoder_inc01_swb8_cs <= '1';
            else
                encoder_inc01_swb8_cs <= '0';
            end if;

            if atmega_nodir_wb8_wrapper00_wbm_address(14 downto 3)="000000001010" and atmega_nodir_wb8_wrapper00_wbm_strobe='1' then
                encoder_inc02_swb8_cs <= '1';
            else
                encoder_inc02_swb8_cs <= '0';
            end if;

            if atmega_nodir_wb8_wrapper00_wbm_address(14 downto 2)="0000000010110" and atmega_nodir_wb8_wrapper00_wbm_strobe='1' then
                compass00_swb8_cs <= '1';
            else
                compass00_swb8_cs <= '0';
            end if;

            if atmega_nodir_wb8_wrapper00_wbm_address(14 downto 1)="00000000101110" and atmega_nodir_wb8_wrapper00_wbm_strobe='1' then
                led00_swb8_cs <= '1';
            else
                led00_swb8_cs <= '0';
            end if;

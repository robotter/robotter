...
entity top_uniocng is
    ...
    -- adns601000-adns_spi
    adns601000_cs3_no : out std_logic;
    -- adns601000-adns_spi
    adns601000_adns_reset_o : out std_logic;
    -- adns601000-adns_spi
    adns601000_mosi_o : out std_logic;
    -- adns601000-adns_spi
    adns601000_sck_o : out std_logic;
    -- adns601000-adns_spi
    adns601000_miso_i : in std_logic;
    -- adns601000-adns_spi
    adns601000_cs2_no : out std_logic;
    -- adns601000-adns_spi
    adns601000_cs1_no : out std_logic;
    -- encoder_inc02-channels
...
architecture top_uniocng_1 of top_uniocng is
    -------------------------
    -- declare components  --
    -------------------------
    ...
    -- adns601000
    -- clock
    signal adns601000_wbs_clk_i :  std_logic;
    signal adns601000_wbs_rst_i :  std_logic;
    -- swb8
    signal adns601000_wbs_adr_i :  std_logic_vector(5 downto 0);
    signal adns601000_wbs_dat_i :  std_logic_vector(7 downto 0);
    signal adns601000_wbs_dat_o :  std_logic_vector(7 downto 0);
    signal adns601000_wbs_we_i :  std_logic;
    signal adns601000_wbs_stb_i :  std_logic;
    signal adns601000_wbs_cyc_i :  std_logic;
    signal adns601000_wbs_ack_o :  std_logic;
    -- adns_spi
    ...
    -- adns601000_swb8
    signal atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_adr_i :  std_logic_vector(5 downto 0);
    signal atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_dat_i :  std_logic_vector(7 downto 0);
    signal atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_dat_o :  std_logic_vector(7 downto 0);
    signal atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_we_i :  std_logic;
    signal atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_stb_i :  std_logic;
    signal atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_cyc_i :  std_logic;
    signal atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_ack_o :  std_logic;
    -- adns601000_clock
    signal atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_clk_i :  std_logic;
    signal atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_rst_i :  std_logic;
    -- encoder_inc00_swb8
...
begin
    ...
    port map (
            -- clock
            wbs_clk_i => adns601000_wbs_clk_i,
            wbs_rst_i => adns601000_wbs_rst_i,
            -- swb8
            wbs_adr_i => adns601000_wbs_adr_i,
            wbs_dat_i => adns601000_wbs_dat_i,
            wbs_dat_o => adns601000_wbs_dat_o,
            wbs_we_i => adns601000_wbs_we_i,
            wbs_stb_i => adns601000_wbs_stb_i,
            wbs_cyc_i => adns601000_wbs_cyc_i,
            wbs_ack_o => adns601000_wbs_ack_o,
            -- adns_spi
            mosi_o => adns601000_mosi_o,
            miso_i => adns601000_miso_i,
            sck_o => adns601000_sck_o,
            cs1_no => adns601000_cs1_no,
            cs2_no => adns601000_cs2_no,
            cs3_no => adns601000_cs3_no,
            adns_reset_o => adns601000_adns_reset_o
            );
    ...
    port map (
            -- adns601000_swb8
            adns601000_wbs_adr_i => atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_adr_i,
            adns601000_wbs_dat_i => atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_dat_i,
            adns601000_wbs_dat_o => atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_dat_o,
            adns601000_wbs_we_i => atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_we_i,
            adns601000_wbs_stb_i => atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_stb_i,
            adns601000_wbs_cyc_i => atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_cyc_i,
            adns601000_wbs_ack_o => atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_ack_o,
            -- adns601000_clock
            adns601000_wbs_clk_i => atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_clk_i,
            adns601000_wbs_rst_i => atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_rst_i,
            -- encoder_inc00_swb8
    ...
    -- connect atmega_nodir_wb8_wrapper00_mwb8_intercon
        -- adns601000_swb8
        atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_dat_o <= adns601000_wbs_dat_o;
        atmega_nodir_wb8_wrapper00_mwb8_intercon_adns601000_wbs_ack_o <= adns601000_wbs_ack_o;
        -- adns601000_clock
        -- encoder_inc00_swb8
